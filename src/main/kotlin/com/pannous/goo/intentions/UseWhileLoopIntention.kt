...
class UseWhileLoopIntention : PsiElementBaseIntentionAction(), IntentionAction {
    
    override fun getText(): String = "Convert 'for' to 'while'"
    
    override fun getFamilyName(): String = "Goo Simplifications"
    
    override fun isAvailable(project: Project, editor: Editor?, element: PsiElement): Boolean {
        val line = getLineContaining(element) ?: return false
        return line.trim().startsWith("for") && !line.contains(" in ") && !line.contains(",")
    }
    ...
    override fun invoke(project: Project, editor: Editor?, element: PsiElement) {
        ...
        val replacement = line.replace("for", "while")
